'''
Discarded method - only works for class 1
'''
import random
...
initial = [random.randint(0,28*28-1) for i in range(80)]
print(initial)
result = sp.optimize.minimize(
    start_training,         # The objective function to minimize
    initial,            # Initial guess for the weights
...
print(result.x)
print(start_training(optimized_weights))
